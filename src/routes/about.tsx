...
export const Route = createFileRoute("/about")({
  head: () => ({
    meta: [
      { title: "About Right Lane Handyman Services, LLC — Clearwater, FL" },
      { name: "description", content: "Learn about Right Lane Handyman Services, LLC, our 25+ Years of experience in Clearwater, FL, and our commitment to quality." },
      { property: "og:title", content: "About Right Lane Handyman Services, LLC" },
      { property: "og:description", content: "Premier landscaping and construction services in Clearwater, FL with 25+ Years of experience." },
...
function AboutPage() {
  ...
  const benefits = [
    {
      title: "25+ Years of Local Experience",
      desc: "Deep-rooted knowledge of Clearwater architectural styles, local building codes, soil requirements, and climate conditions.",
    },
    {
      title: "Owner-Led Oversight",
      desc: "Right Lane Handyman is directly involved in the planning and execution of every project, ensuring superior quality control and attention to detail.",
    },
    {
        ...
        <section className="relative mx-auto max-w-[1400px] w-full rounded-[10px] overflow-hidden border border-[#eae8e1] shadow-[0_12px_40px_rgb(0,0,0,0.06)] min-h-[380px] md:min-h-[460px] flex items-center justify-center text-center px-6 py-16">
          ...
          >
            ...
            <h1 className="text-[26px] sm:text-3xl md:text-5xl lg:text-6xl font-extrabold text-white leading-tight capitalize tracking-tight drop-shadow-[0_2px_10px_rgba(0,0,0,0.5)]">
              Building Clearwater's Trust,<br className="hidden sm:inline" /> One Project at a Time
            </h1>
          </motion.div>
          ...
          <div className="grid gap-12 lg:grid-cols-[1.3fr_1fr] lg:gap-20 items-center">
            ...
            >
              ...
              <p className="text-base text-neutral-700 leading-relaxed font-light first-letter:text-5xl first-letter:font-extrabold first-letter:text-[#cc7e14] first-letter:float-left first-letter:mr-3 first-letter:mt-1">
                For over 25+ Years, Right Lane Handyman Services, LLC has stood as a pillar of quality, integrity, and craftsmanship in the Clearwater community. Founded and led by Right Lane Handyman, our family-owned and operated business was built on a simple, unwavering principle: to transform our clients' visions into enduring realities with unmatched reliability and skill.
              </p>
              <p className="text-base text-neutral-700 leading-relaxed font-light">
                What began as a dedicated landscaping operation has, through over two decades of trusted service, grown into a full-service design and construction firm. We specialize in seamlessly blending indoor remodeling with outdoor living spaces, creating cohesive environments that enhance both the beauty and functionality of your property.
              </p>
            </motion.div>
            ...
            >
              ...
              <img
                src={welImg}
                alt="Beautiful Right Lane outdoor transformation project"
        ...
        <section className="mx-auto max-w-[1400px] w-full rounded-[10px] bg-[#f8f8f8] border border-[#eae8e1] shadow-[0_12px_40px_rgb(0,0,0,0.03)] px-6 py-20 md:px-12 lg:px-16">
          ...
          >
            ...
            <p className="mt-4 text-neutral-600 text-sm md:text-base">
              Our extensive experience encompasses both residential and commercial projects across an Clearwater and surrounding areas around Clearwater.
            </p>
          </motion.div>
            ...
            {expertiseItems.map((item, idx) => {
              ...
              return (
                <motion.div
                  ...
                  className="group relative bg-white rounded-2xl border border-neutral-200/50 p-6 shadow-sm hover:shadow-lg hover:scale-[1.02] hover:border-[#ffa326]/30 transition-all duration-300 flex flex-col justify-between overflow-hidden"
                >
                  {/* Floating Giant Numerals background */}
                  <span className="absolute right-4 top-2 text-6xl font-black text-neutral-100/60 group-hover:text-[#ffa326]/5 select-none pointer-events-none transition-colors duration-300">
                    {doubleDigit}
                  </span>
                  ...
                  <div className="mt-6 flex items-center text-xs font-bold text-[#cc7e14] gap-1 group/btn cursor-pointer hover:opacity-85 select-none w-fit relative z-10">
        ...
        <section className="mx-auto max-w-[1400px] w-full rounded-[10px] bg-[#fbfaf7] border border-[#eae8e1] shadow-[0_12px_40px_rgb(0,0,0,0.03)] px-6 py-20 md:px-12 lg:px-16">
          ...
          >
            ...
            <p className="mt-4 text-neutral-600 text-sm md:text-base leading-relaxed">
              For over over two decades, Right Lane has grown through excellence, building our legacy one backyard and home at a time in Clearwater.
            </p>
          </motion.div>
          ...
          <div className="relative max-w-4xl mx-auto">
            ...
            <div className="relative flex flex-col sm:flex-row items-stretch gap-8 sm:gap-0 mb-12 sm:mb-16">
              <div className="w-full sm:w-1/2 pl-16 sm:pl-0 sm:pr-12 text-left sm:text-right flex flex-col justify-center items-start sm:items-end">
                <span className="text-sm font-black text-[#cc7e14] bg-[#ffa326]/10 border border-[#ffa326]/20 px-3 py-1 rounded-full mb-2">1990</span>
                ...
                <p className="mt-2 text-xs md:text-sm text-neutral-600 font-light leading-relaxed">
                  Right Lane Handyman establishes a small, dedicated landscaping team in Clearwater, focusing on premium garden care and customized residential design.
                </p>
              </div>
              <div className="absolute left-[29px] sm:left-1/2 h-8 w-8 rounded-full border-4 border-white bg-[#ffa326] shadow-md -translate-x-[50%] flex items-center justify-center top-1 sm:top-1/2 sm:-translate-y-1/2 z-10" />
            ...
            <div className="relative flex flex-col sm:flex-row items-stretch gap-8 sm:gap-0 mb-12 sm:mb-16">
              ...
              <div className="w-full sm:w-1/2 pl-16 sm:pl-12 text-left flex flex-col justify-center items-start">
                <span className="text-sm font-black text-[#cc7e14] bg-[#ffa326]/10 border border-[#ffa326]/20 px-3 py-1 rounded-full mb-2">2005</span>
                <h3 className="text-lg font-bold text-neutral-900">Expanding to Hardscapes</h3>
                <p className="mt-2 text-xs md:text-sm text-neutral-600 font-light leading-relaxed">
                  Through over two decades of trusted service, the team transitions into custom masonry, brickwork, paving, covered patios, and complex flagstone installation.
                </p>
              </div>
            </div>
            ...
            <div className="relative flex flex-col sm:flex-row items-stretch gap-8 sm:gap-0 mb-12 sm:mb-16">
              <div className="w-full sm:w-1/2 pl-16 sm:pl-0 sm:pr-12 text-left sm:text-right flex flex-col justify-center items-start sm:items-end">
                <span className="text-sm font-black text-[#cc7e14] bg-[#ffa326]/10 border border-[#ffa326]/20 px-3 py-1 rounded-full mb-2">2015</span>
                <h3 className="text-lg font-bold text-neutral-900">Full Design-Build Renovation</h3>
                <p className="mt-2 text-xs md:text-sm text-neutral-600 font-light leading-relaxed">
                  Right Lane integrates full-scale interior home remodeling and custom outdoor living creations under one roof, establishing full design-build capability.
                </p>
              </div>
              <div className="absolute left-[29px] sm:left-1/2 h-8 w-8 rounded-full border-4 border-white bg-[#ffa326] shadow-md -translate-x-[50%] flex items-center justify-center top-1 sm:top-1/2 sm:-translate-y-1/2 z-10" />
              <div className="hidden sm:block w-full sm:w-1/2" />
            ...
            <div className="relative flex flex-col sm:flex-row items-stretch gap-8 sm:gap-0">
              ...
              <div className="absolute left-[29px] sm:left-1/2 h-8 w-8 rounded-full border-4 border-white bg-[#ffa326] shadow-md -translate-x-[50%] flex items-center justify-center top-1 sm:top-1/2 sm:-translate-y-1/2 z-10" />
              <div className="w-full sm:w-1/2 pl-16 sm:pl-12 text-left flex flex-col justify-center items-start">
                <span className="text-sm font-black text-[#cc7e14] bg-[#ffa326]/10 border border-[#ffa326]/20 px-3 py-1 rounded-full mb-2">Present</span>
                <h3 className="text-lg font-bold text-neutral-900">Clearwater's Trusted Team</h3>
                <p className="mt-2 text-xs md:text-sm text-neutral-600 font-light leading-relaxed">
                  Now celebrating over 25+ Years of trusted craftsmanship, the Right Lane team maintains active oversight on every single premium project we start.
                </p>
              </div>
            </div>
          </div>
      ...
      <div className="w-full bg-[#f4f3ef] pt-[10px] pb-[10px] px-[15px]">
        <section className="mx-auto max-w-[1400px] w-full rounded-[10px] bg-[#f1e8db] border border-[#eae8e1] shadow-[0_12px_40px_rgb(0,0,0,0.04)] px-6 py-20 md:px-12 lg:px-16">
          <motion.div
            ...
            className="text-center max-w-3xl mx-auto mb-16"
          >
            <span className="inline-flex items-center bg-[#2b1a05] border border-[#593203]/30 text-white rounded-full px-5 py-1.5 text-[11px] font-extrabold uppercase tracking-wider mb-4 shadow-sm">
              Our Leadership
            </span>
            <h2 
              className="text-3xl md:text-4xl font-extrabold text-neutral-950 tracking-tight"
          ...
          <div className="grid lg:grid-cols-[1.3fr_1fr] gap-12 items-center max-w-5xl mx-auto">
            ...
            <div className="grid sm:grid-cols-2 gap-6 w-full">
              ...
              >
                ...
                <div className="w-20 h-20 rounded-full bg-gradient-to-br from-[#ffa326] to-[#cc7e14] border-4 border-white flex items-center justify-center mb-5 text-white text-xl font-bold shadow-md select-none group-hover:scale-105 transition-transform duration-300">
                  RT
                </div>
                <h3 className="text-md font-bold text-neutral-900 tracking-wide">Right Lane Handyman</h3>
                ...
                <p className="mt-4 text-xs text-neutral-600 font-light leading-relaxed">
                  Founder with 25+ Years of active field oversight, ensuring every project holds a lasting lifetime value.
                </p>
              </motion.div>
              ...
              >
                {/* Profile avatar with initials */}
                <div className="w-20 h-20 rounded-full bg-gradient-to-br from-[#cc7e14] to-[#1c140d] border-4 border-white flex items-center justify-center mb-5 text-white text-xl font-bold shadow-md select-none group-hover:scale-105 transition-transform duration-300">
                  A
                </div>
            ...
            >
              <div className="space-y-4">
                ...
                <p className="text-sm font-light leading-relaxed text-neutral-200 italic" style={{ fontFamily: "Georgia, serif" }}>
                  Every brick we lay, wall we frame, or garden we style represents our name in the Clearwater community. We stand behind our work with a simple family promise: absolute honesty, transparent billing, and craftsmanship built to last.
                </p>
              </div>

              <div className="mt-8 pt-6 border-t border-white/10 flex items-center justify-between">
                <div>
                  <h4 className="text-sm font-bold tracking-wide">Right Lane Handyman</h4>
                  <span className="text-[10px] text-neutral-400 font-semibold uppercase tracking-wider">Owner, Right Lane Handyman Services, LLC</span>
                </div>
                {/* Simulated signature using Georgia italic styling */}
                <span className="text-2xl text-[#ffa326] font-normal italic select-none" style={{ fontFamily: "Georgia, 'Times New Roman', serif" }}>
                  R. Thompson
                </span>
              </div>
            </motion.div>
          ...
          <div className="grid gap-12 lg:grid-cols-[1fr_1.3fr] lg:gap-16 items-center">
            ...
            >
              ...
              <h2 
                ...
                style={{ fontFamily: "Georgia, serif" }}
              >
                Why Property Owners Choose Right Lane
              </h2>
              <p className="text-base text-neutral-700 leading-relaxed font-light">
                Whether you need 24/7 emergency service or are planning a dream renovation, our skilled team brings the same level of dedication, precision, and hands-on expertise that the Right Lane team has personally guaranteed since day one.
              </p>
            </motion.div>
        ...
        >
          ...
          >
            ...
            <p className="text-sm md:text-base text-neutral-300 leading-relaxed font-light mb-10 max-w-3xl">
              At Right Lane Handyman Services, LLC, we don't just build patios and remodel kitchens—we build relationships and trust that last for generations. We are proud to be a part of the Clearwater community and are dedicated to contributing to its beauty and growth, one exceptional project at a time.
            </p>
            ...
            <div className="bg-white/5 border border-white/10 backdrop-blur-md rounded-2xl p-8 w-full max-w-3xl mb-10 text-left">
              ...
              <p className="text-sm text-neutral-300 font-light mb-6 text-center sm:text-left">
                Contact us today to schedule your free, no-obligation consultation with Ronnie.
              </p>
              ...
              <div className="grid sm:grid-cols-2 gap-5 text-[15px] font-light">
                ...
                <div className="flex items-center gap-3.5">
                  <Clock className="w-5 h-5 text-[#ffa326] shrink-0" />
                  <span>Mon-Sat: 8am-5pm | 24/7 Support</span>
                </div>
                <div className="flex items-center gap-3.5">
                  <MapPin className="w-5 h-5 text-[#ffa326] shrink-0" />
                  <span>Clearwater & 80-Mile Surrounding Area</span>
                </div>
              </div>
            </div>
