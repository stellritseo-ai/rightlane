...
export const Route = createFileRoute("/debris-removal-tarpon-springs")({
  head: () => ({
    meta: [
      { title: "Debris Removal Tarpon Springs - Right Lane Handyman Services, LLC" },
      {
        name: "description",
        content:
          "Top-rated Debris Removal in Tarpon Springs. Professional storm cleanup, yard waste, and post-construction debris removal. Call (727) 642-0201 today.",
      },
      { property: "og:title", content: "Debris Removal Tarpon Springs - Right Lane Handyman" },
      { property: "og:description", content: "Top-rated Debris Removal in Tarpon Springs. Professional storm cleanup and debris removal." },
      { property: "og:type", content: "website" },
    ],
  }),
  component: DebrisRemovalTarponSpringsPage,
});
...
function DebrisRemovalTarponSpringsPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      await addLead({
        ...
        address: fullAddress,
        projectType: "Debris Removal Tarpon Springs",
      ...
      await addWebEmail({
        ...
        email: formData.email,
        phone: formData.phone,
        service: "Debris Removal Tarpon Springs",
        message: `${projectDescription}\n\nAddress: ${fullAddress}`,
        source: "debris_removal_tarpon_springs_page",
      });
      setIsSubmitted(true);
    } catch (err) {
        ...
        <section className="relative mx-auto max-w-[1400px] w-full rounded-[10px] overflow-hidden border border-[#eae8e1] shadow-[0_12px_40px_rgb(0,0,0,0.06)] min-h-[460px] md:min-h-[520px] flex items-center justify-center text-center px-6 py-16">
          ...
          >
            ...
            <p className="mt-5 text-sm sm:text-base text-neutral-300 font-light leading-relaxed max-w-3xl">
              Right Lane Handyman Services provides top-rated debris removal in Tarpon Springs. Whether you need storm cleanup, yard waste hauling, or post-construction debris removal, our experienced team ensures fast, reliable, and eco-friendly service.
            </p>
