...
export const Route = createFileRoute("/hauling-services-palm-harbor")({
  head: () => ({
    meta: [
      { title: "Hauling Services Palm Harbor - Right Lane Handyman Services, LLC" },
      {
        name: "description",
        content:
          "Top-rated Hauling Services in Palm Harbor. Professional residential and commercial heavy debris hauling and appliance removal. Call (727) 642-0201 today.",
      },
      { property: "og:title", content: "Hauling Services Palm Harbor - Right Lane Handyman" },
      { property: "og:description", content: "Top-rated Hauling Services in Palm Harbor. Professional heavy debris hauling." },
      { property: "og:type", content: "website" },
    ],
  }),
  component: HaulingServicesPalmHarborPage,
});
...
function HaulingServicesPalmHarborPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      await addLead({
        ...
        address: fullAddress,
        projectType: "Hauling Services Palm Harbor",
      ...
      await addWebEmail({
        ...
        email: formData.email,
        phone: formData.phone,
        service: "Hauling Services Palm Harbor",
        message: `${projectDescription}\n\nAddress: ${fullAddress}`,
        source: "hauling_palm_harbor_page",
      });
      setIsSubmitted(true);
    } catch (err) {
        ...
        <section className="relative mx-auto max-w-[1400px] w-full rounded-[10px] overflow-hidden border border-[#eae8e1] shadow-[0_12px_40px_rgb(0,0,0,0.06)] min-h-[460px] md:min-h-[520px] flex items-center justify-center text-center px-6 py-16">
          ...
          >
            ...
            <p className="mt-5 text-sm sm:text-base text-neutral-300 font-light leading-relaxed max-w-3xl">
              Right Lane Handyman Services provides top-rated hauling services in Palm Harbor. From hauling away old appliances to removing heavy construction debris, our experienced team ensures fast, reliable, and professional service.
            </p>
