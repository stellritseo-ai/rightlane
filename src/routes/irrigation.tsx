...
export const Route = createFileRoute("/irrigation")({
  head: () => ({
    meta: [
      { title: "Professional Irrigation & Sprinkler Services Clearwater — Right Lane Handyman Services, LLC" },
      { name: "description", content: "Get code-compliant, professional irrigation design, installation, repairs, and smart controller upgrades in Clearwater, FL. 25+ Years experience. Call (727) 642-0201." },
      { property: "og:title", content: "Irrigation Services in Clearwater | Right Lane Handyman Services, LLC" },
      { property: "og:description", content: "Efficient sprinkler systems, drip irrigation, seasonal checks, and TCEQ backflow compliance designed and built by Right Lane." },
...
function IrrigationPage() {
  ...
  const irrigationProcess = [
    ...
    },
    {
      ...
      desc: "Ronnie creates a tailored irrigation plan mapping out zones, pressure demands, head choices, and backflow layout to ensure code compliance."
    },
    {
      number: "03",
  ...
  const whyChooseUs = [
    {
      ...
      desc: "We build systems in strict compliance with the City of Clearwater and TCEQ guidelines, including required backflow assemblies and permit filings."
    },
    {
    ...
    {
      title: "25+ Years of Landscape Knowledge",
    ...
    },
    {
      ...
      desc: "the Right Lane team directly oversees every project, ensuring visual layout details and structural trenches meet Right Lane's high standards."
    }
  ];
      ...
      <div className="w-full bg-[#f4f3ef] pt-[5px] pb-[5px] px-[15px]">
        <section className="relative mx-auto max-w-[1400px] w-full rounded-[10px] overflow-hidden border border-[#eae8e1] shadow-[0_12px_40px_rgb(0,0,0,0.06)] min-h-[420px] md:min-h-[500px] flex items-center justify-center text-center px-6 py-16">
          ...
          >
            ...
            >
              Irrigation Services in Clearwater
            </h1>
          ...
          <div className="grid gap-12 lg:grid-cols-[1.3fr_1fr] lg:gap-20 items-center">
            ...
            >
              ...
              <p className="text-base text-neutral-700 leading-relaxed font-light first-letter:text-5xl first-letter:font-extrabold first-letter:text-[#cc7e14] first-letter:float-left first-letter:mr-3 first-letter:mt-1">
                A beautiful landscape deserves a reliable watering system that keeps it thriving while conserving water and protecting your investment. At Right Lane Handyman Services, LLC, we provide professional irrigation installation and maintenance services designed for the unique needs of Clearwater properties.
              </p>
              <p className="text-base text-neutral-700 leading-relaxed font-light">
                With over 25+ Years of landscape and construction experience, the Right Lane team understands that proper irrigation is the unsung hero of a healthy, vibrant property. We build water-wise, fully automated systems that feed your plants and lawn exactly what they need, without wasting a drop.
              </p>
              <p className="text-base text-neutral-700 leading-relaxed font-light">
            ...
            >
              ...
              <img
                src={imgSoftscapes}
                alt="Lush green lawn and softscapes irrigated by Right Lane"
        ...
        <section className="mx-auto max-w-[1400px] w-full rounded-[10px] bg-[#fbfaf7] border border-[#eae8e1] shadow-[0_12px_40px_rgb(0,0,0,0.03)] px-6 py-20 md:px-12 lg:px-16">
          ...
          >
            ...
            <h2 
              ...
              style={{ fontFamily: "Georgia, serif" }}
            >
              The Right Lane Irrigation Process
            </h2>
            <p className="mt-4 text-neutral-600 text-sm md:text-base leading-relaxed font-light">
          ...
          <div className="grid gap-12 lg:grid-cols-[1fr_1.3fr] lg:gap-16 items-center">
            ...
            >
              ...
              <h2 
                ...
                style={{ fontFamily: "Georgia, serif" }}
              >
                Why Choose Right Lane for Your Irrigation Needs?
              </h2>
              <p className="text-base text-neutral-700 leading-relaxed font-light">
                An irrigation system must balance smart conservation with high performance. With 25+ Years of hands-on expertise, we ensure your layout meets TCEQ guidelines while lowering your utility bill.
              </p>
            </motion.div>
