...
export const Route = createFileRoute("/softscapes")({
  head: () => ({
    meta: [
      { title: "Softscape Design & Installation Clearwater — Right Lane Handyman Services, LLC" },
      { name: "description", content: "Bring your landscape to life. Custom planting beds, Texas-native xeriscaping, ornamental trees, and sod installation in Clearwater, FL. 25+ Years experience. Call (727) 642-0201." },
      { property: "og:title", content: "Softscape Design & Installation in Clearwater | Right Lane Handyman Services, LLC" },
  ...
  const softscapeServices = [
    {
      ...
      items: [
        ...
        "Drought-Tolerant Xeriscaping: Resilient, water-wise gardens combining native plants with gravel or mulch beds for Clearwater's climate."
      ]
    },
    {
  ...
  const softscapeProcess = [
    {
      ...
      desc: "Right Lane Handyman conducts a free, on-site consultation to analyze soil pH, sun/shade boundaries, and drainage microclimates."
    },
    {
      number: "02",
  ...
  const whyChooseUs = [
    {
      ...
      desc: "We combine 25+ Years of local horticultural wisdom with modern layout design. We know exactly what plants survive Clearwater heat."
    },
    {
        ...
        <section className="relative mx-auto max-w-[1400px] w-full rounded-[10px] overflow-hidden border border-[#eae8e1] shadow-[0_12px_40px_rgb(0,0,0,0.06)] min-h-[420px] md:min-h-[500px] flex items-center justify-center text-center px-6 py-16">
          ...
          >
            ...
            <p className="mt-6 text-sm md:text-base text-neutral-300 font-light leading-relaxed max-w-3xl mx-auto">
              Bring Your Landscape to Life with 25+ Years of Living Artistry
            </p>
          </motion.div>
          ...
          <div className="grid gap-12 lg:grid-cols-[1.3fr_1fr] lg:gap-20 items-center">
            ...
            >
              ...
              <p className="text-base text-neutral-700 leading-relaxed font-light first-letter:text-5xl first-letter:font-extrabold first-letter:text-[#cc7e14] first-letter:float-left first-letter:mr-3 first-letter:mt-1">
                The soul of any beautiful outdoor space lies in its living elements—the vibrant colors, textured foliage, and seasonal blooms that create atmosphere and harmony. At Right Lane Handyman Services, LLC, we specialize in custom softscape design and installation, transforming blank canvases of soil into thriving, dynamic landscapes that engage the senses and complement your home’s architecture.
              </p>
              <p className="text-base text-neutral-700 leading-relaxed font-light">
                With over 25+ Years of dedicated horticultural and design experience, the Right Lane team brings a deep understanding of Texas-native and adapted plants to create gardens that are not only stunning but also sustainable and manageable.
              </p>
              <p className="text-base text-neutral-700 leading-relaxed font-light">
            ...
            >
              ...
              <img
                src={imgSoftscapes}
                alt="Colorful softscape garden bed design by Right Lane"
        ...
        <section className="mx-auto max-w-[1400px] w-full rounded-[10px] bg-[#fbfaf7] border border-[#eae8e1] shadow-[0_12px_40px_rgb(0,0,0,0.03)] px-6 py-20 md:px-12 lg:px-16">
          ...
          >
            ...
            <h2 
              ...
              style={{ fontFamily: "Georgia, serif" }}
            >
              The Right Lane Softscape Process
            </h2>
            <p className="mt-4 text-neutral-600 text-sm md:text-base leading-relaxed font-light">
          ...
          <div className="grid gap-12 lg:grid-cols-[1fr_1.3fr] lg:gap-16 items-center">
            ...
            >
              ...
              <h2 
                ...
                style={{ fontFamily: "Georgia, serif" }}
              >
                Why Choose Right Lane for Your Softscape?
              </h2>
              <p className="text-base text-neutral-700 leading-relaxed font-light">
