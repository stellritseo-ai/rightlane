...
export const Route = createFileRoute("/demolition-services-pinellas-county")({
  head: () => ({
    meta: [
      { title: "Demolition Services Pinellas County - Right Lane Handyman Services, LLC" },
      {
        name: "description",
        content:
          "Top-rated Demolition Services in Pinellas County. Professional residential and commercial demolition, structure removal, and debris hauling. Call (727) 642-0201 today.",
      },
      { property: "og:title", content: "Demolition Services Pinellas County - Right Lane Handyman" },
      { property: "og:description", content: "Top-rated Demolition Services in Pinellas County. Professional residential and commercial demolition." },
      { property: "og:type", content: "website" },
    ],
  }),
  component: DemolitionServicesPinellasCountyPage,
});
...
function DemolitionServicesPinellasCountyPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      await addLead({
        ...
        address: fullAddress,
        projectType: "Demolition Services Pinellas County",
      ...
      await addWebEmail({
        ...
        email: formData.email,
        phone: formData.phone,
        service: "Demolition Services Pinellas County",
        message: `${projectDescription}\n\nAddress: ${fullAddress}`,
        source: "demolition_pinellas_page",
      });
      setIsSubmitted(true);
    } catch (err) {
        ...
        <section className="relative mx-auto max-w-[1400px] w-full rounded-[10px] overflow-hidden border border-[#eae8e1] shadow-[0_12px_40px_rgb(0,0,0,0.06)] min-h-[460px] md:min-h-[520px] flex items-center justify-center text-center px-6 py-16">
          ...
          >
            ...
            <p className="mt-5 text-sm sm:text-base text-neutral-300 font-light leading-relaxed max-w-3xl">
              Right Lane Handyman Services provides top-rated demolition services across Pinellas County. From tearing down sheds and interior guts to breaking up concrete and complete site cleanouts, our experienced team ensures safe, reliable, and professional demolition.
            </p>
